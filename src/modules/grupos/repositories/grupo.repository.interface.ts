...
export interface GrupoRepository {
  ...
  atualizar(id: string, data: Partial<{ nome: string; icone: string; privado: boolean; maxParticipantes: number; permitirPalpiteAutomatico: boolean; ativo: boolean; permitirPalpiteDobrado: boolean; codigoConvite: string; criadoPor: string }>): Promise<any>;
