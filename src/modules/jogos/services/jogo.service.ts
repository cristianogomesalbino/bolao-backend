...
export class JogoService {
  ...
  private async finalizarPontosCorridos(jogo: JogoInterno, dto: FinalizarJogoDto) {
  ...
  private async finalizarMataMata(jogo: JogoInterno, fase: any, dto: FinalizarJogoDto) {
  ...
  private async finalizarMataMataSimples(jogo: JogoInterno, dto: FinalizarJogoDto) {
  ...
  private async finalizarMataMataComEmpate(jogo: JogoInterno, dto: FinalizarJogoDto) {
    if (!dto.temProrrogacao) {
