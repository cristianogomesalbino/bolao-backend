...
type CategoriaAcerto = 'ACERTO_EM_CHEIO' | 'ACERTO_DE_RESULTADO' | 'ERRO_TOTAL';
  ...
  calcular(
    ...
    if (
      ...
      return {
        ...
        pontosBase: RANKING.PONTOS.ACERTO_EM_CHEIO,
      };
    }
    ...
    if (resultadoPalpite === resultadoJogo) {
      return {
        ...
        pontosBase: RANKING.PONTOS.ACERTO_DE_RESULTADO,
      };
    }

    return {
      categoriaAcerto: 'ERRO_TOTAL',
      pontosBase: RANKING.PONTOS.ERRO_TOTAL,
    };
  }
}
