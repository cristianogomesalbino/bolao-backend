...
describeAttemptSuite(test, {
  ...
  scenarios: [
    ...
    { perfil: 'usuario_comum', method: 'PATCH', statusEsperado: HTTP.OK },
    { perfil: 'super_admin', method: 'PATCH', statusEsperado: HTTP.OK },
    { perfil: 'usuario_comum', method: 'PATCH', statusEsperado: HTTP.BAD_REQUEST, routeOverride: `usuarios/${INVALID.UUID}` },
    { perfil: 'usuario_comum', method: 'PATCH', statusEsperado: HTTP.FORBIDDEN, routeOverride: `usuarios/${INVALID.UUID_INEXISTENTE}` },
  ],
