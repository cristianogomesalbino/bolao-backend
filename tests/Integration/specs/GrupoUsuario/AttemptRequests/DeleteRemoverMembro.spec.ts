...
describeAttemptSuite(test, {
  descricao: 'Attempt DELETE /grupos/:id/usuarios/:usuarioId',
  ...
  routeResolver: (data) => `grupos/${data.grupoId}/usuarios/${INVALID.UUID_INEXISTENTE}`,
  // prettier-ignore
  scenarios: [
    ...
    ['admin_grupo',    'DELETE', HTTP.NOT_FOUND,     'admin — usuário inexistente no grupo'],
  ],
});
